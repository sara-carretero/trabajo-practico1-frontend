//Se le agrega el signo $ adelante de las variables que tienen almacenaado un elemento HTML para una ayuda visual.
...
//4. llaves (tecnicamente se llama 'scope'. Es la zona privada de la función) -> {}
...
function sendMessage() {
  ...
  //Coloco la hora de cuando se envió el msj.
  ...
  //Limpiamos el input con un "" que llama string vacío.
  $inputMessage.value = ""
